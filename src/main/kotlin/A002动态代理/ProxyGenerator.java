...
//  private static final int opc_jsr_w                  = 201;
    ...
    //java.security.AccessController.doPrivileged(new GetBooleanAction("jdk.proxy.ProxyGenerator.saveGeneratedFiles")).booleanValue();
...
//  }
    ...
    private static class ConstantPool {
         ...
         */
        private final List<ConstantPool.Entry> pool = new ArrayList<>(32);
         ...
         * values of all types.
         */
        private final Map<Object, Integer> map = new HashMap<>(16);
